...
<p>Hello <%=u.getFirstName()%>, to change your email or password please contact admin.</p>
            ...
            <table align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" value="${param.user_Id}" name="user_Id"/>
                         	<input type="text" value="${row.address}" name="address" /></td>
                        </tr> 
                        <tr>
                        <th>City</th>
                        ...
                        <tr>
                        <th>Zip Code</th>
                        <td><input type="text" value="${row.zipcode}" name="zipcode"/></td>
                        </tr>
                        <tr>
                        <th>Phone Number</th>
                        <td><input type="text" value="${row.phonenumber}" name="phonenumber"/></td>
                        </tr>
